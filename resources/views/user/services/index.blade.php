        ...
        <div class="container" style="max-width: 950px">
            @if(session()->has('message'))
                <div id="message" class="alert alert-info">
                    ...
                    <span  class="text-white text-center">{{session()->get('message')}}</span>
                </div>
            @endif
            <br><br>
                ...
                <div class="card mb-0 "  >
                    ...
                    <div class="card-body courses_body" style="font-family: ar;color: #808080">
                        ...
                        <div class="item-card2 ">
                            <h2 style="font-family: 'ab'" class="text-center">{{$service->title}}</h2><br><br>
                            <div class="item-card2-desc" style="font-family: 'ar'" >

                                <p class="" style="letter-spacing: 0.5px;text-align: justify">{!!$service->description!!}</p>

                            </div>
                        </div>
                    </div>

                    <div class="card-body" style="font-family: ar;color: #808080">
                        <form class="" action="{{route('service-order')}}" method="POST">
                            @csrf
                        <div class="row">
                            @if(auth()->guard('web')->check() && auth()->guard('web')->user()->type == 0)
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select class="form-control" style="  box-shadow: 0px -1px 3px 0px rgba(0,0,0,0.2)" name="service_id" >
                                            <option value="{{$service->id}}" selected  style="font-family: 'ar';color: #AAAAA9" readonly>{{$service->title}}</option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" placeholder="الإيميل " class="form-control" style="font-family: 'ar'" autocomplete="off" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="full_name" placeholder="الأسم كامل" class="form-control" autocomplete="off" style="font-family: 'ar'" required>

                                </div>
                                    <div class="form-group">
                                        <div class="row">

                                            <input type="number" name="phone" placeholder=" الجوال" class="form-control col-md-6"  autocomplete="off" style="font-family: 'ar'" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="content" rows="6" cols="70" placeholder="تفاصيل الطلب" style="  box-shadow: 0px -1px 3px 0px rgba(0,0,0,0.2)" required>
</textarea>
                            </div>
                            </div>
                        </div>
                        ...
                        <br>
                        <input type="submit" class="btn btn-danger btn-block  text-white float-right" value="طلب الخدمه" style="box-shadow: 0px 0px 11px 0px rgba(0,0,0,0.2);font-family:ar;height: 40px"/>
                        </form>
...
;border-radius: 10px;max-width: 500px ;height: 445px">
                            ...
                            <div class="card-body" style="height: 125px;font-family: ar;color: #8080">
                                <div class="item-card2-desc" >
                                    ...
                                    {{--                                        </ul>--}}
                                    <p class="mb-0" style="padding-top: 12px">{{\Illuminate\Support\Str::limit($service->description , 100)}}</p>
                                </div>
                            </div>
            ...
            for (var i = 0; i < elements.length; i++) {
                elements[i].oninvalid = function(e) {
                    ...
                    if (!e.target.validity.valid) {
                        e.target.setCustomValidity("برجاء إدخال بيانات هذا الحقل ");
                        notValid = 0;
                    }
                };
