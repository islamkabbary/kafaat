                    ...
                    <div class="card-body">
                        <form action="{{route('ads.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" style="font-family:ar" class="form-control" required placeholder="الاسم">
                            </div>
                            <div class="form-group">
                                <label class="form-label" style="font-family:ar">الوصف</label>
                                <textarea col="50" rows="4" style="font-family:ar;resize:none" name="description1" class="form-control" required placeholder="الوصف"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ads_link" style="font-family:ar" class="form-control" placeholder="رابط إعلاني">
                            </div>
