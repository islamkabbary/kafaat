                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">  فاتوره الحواله البنكيه</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button onclick="printDiv('printableArea')"   class="btn btn-success btn-block" >طباعه الفاتورة</button>

                                        </div>

                                        <div class="col-md-6">
                                            <a href="{{$receipt->receipt}}"   class="btn btn-warning btn-block" download >تنزيل الفاتورة</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
