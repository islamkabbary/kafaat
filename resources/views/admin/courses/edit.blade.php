        ...
        <div class="page-main h-100 container">
            ...
            <div class="app-content my-3 my-md-5">
                <div class="side-app">
                    ...
                    {{--                        </div>--}}
                    {{--                    </div>--}}
                    <form id="myForm" action="{{route('courses.update',$course->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{method_field('PUT')}}
                            ...
                            <div class="collapse" id="collapseExample">
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="code" class="form-control" id="exampleInputname" value="{{$course->code}}"    placeholder="كود الدورة" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" class="form-control" id="txtDate" value="{{$course->date}}" placeholder="تاريخ الدورة" required>
                                    </div>
                            ...
                            <div class="collapse" id="collapseExample3">
                                ...
                                <div class="form-group">
                                    <label > وصف الدورة</label>
                                        ...
                                        <textarea class="form-control" name="descriptionCourse" rows="4" placeholder="وصف الدورة" required>{{$course->description}}</textarea>
                ...
                <?php $counter++ ?>
                        ...
                        <div class="form-group mb-0">
                            <div class="checkbox checkbox-secondary">
                                <button type="submit" class="btn btn-danger btn-block ">تعديل الدورة</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center" style="padding: 40px">
                                <h3>جارى تعديل المحتوى يرجى الإنتظار </h3>
