                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">مديرين النظام</h3>
                                </div>
                                <div class="card-body">
...
{{--                                                <th>الحساب مفعل ؟</th>--}}
                                            ...
                                            @foreach($admins as $admin)
                                                <tr>
                                                    ...
                                                    <td><img src="{{$admin->photo}}" width="85px" height="85px"></td>
{{--                                                    <td >--}}
{{--                                                        @if($admin->verified == 1)--}}
{{--                                                            مفعل--}}
{{--                                                        @else--}}
...
{{--                                                    </td>--}}
                                                    <td>
                                                        ...
                                                        <a  href="#" onclick="popUpConfirmDelete({{$admin->id}})" class="btn btn-sm btn-danger">حذف</a>
                                                        <a href="{{url('/admin/admins/update/'.$admin->id)}}" class="btn btn-sm btn-info">تعديل</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="padding: 40px">
                                    <h5 class="modal-title text-danger" style="font-family: 'ab';text-align: center">هل تريد  حذف هذا المدير من النظام !</h5>
    ...
    <script>
        ...
        function deleteUser(){
            ...
            $.ajax({
                url : "{{url('/admin/admins/delete/')}}"+"/"+user_id,
                type : 'GET',
                success:function (){
               location.reload();
