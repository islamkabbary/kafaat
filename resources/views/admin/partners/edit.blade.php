            ...
            <div class="app-content my-3 my-md-5">
                <div class="side-app">
                    ...
                    <div class="card m-b-20" style="max-width: 1000px">
                        <div class="card-header">
                            <h3 class="card-title">إضافه شريك جديد</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{route('partners.update' , $partner->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" class="form-control" id="exampleInputname"  value="{{$partner->company_name}}" placeholder="إسم الشريك">
                                </div>

                                <div class="form-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="logo">
                                        <label class="custom-file-label">الصوره</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    <div class="checkbox checkbox-secondary">
                                        <button type="submit" class="btn btn-danger btn-block ">إضافه جديده</button>
                                    </div>
                                </div>
                            </form>
                        </div>
