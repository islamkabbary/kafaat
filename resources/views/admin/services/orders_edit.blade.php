                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">تعديل طلب الخدمه</h3>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="email" name="email" placeholder="الإيميل " class="form-control" value="{{$order->email}}" style="font-family: 'ar'" autocomplete="off" required >
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="full_name" name="full_name" placeholder="الأسم كامل" class="form-control" autocomplete="off" value="{{$order->full_name}}" style="font-family: 'ar'" required >

                                                </div>

                                                <div class="form-group">
                                                    <label class="form-label" for="exampleInputEmail1">رقم الجوال</label>
                                                    <input type="text" id="phone" name="phone" placeholder="الجوال" class="form-control"  autocomplete="off" value="{{$order->phone}}" style="font-family: 'ar'" required >
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <label class="form-label" for="exampleFormControlTextarea1">تفاصيل الطلب</label><textarea   class="form-control" name="content" id="content" rows="3" placeholder="وصف طلب الخدمه" style="  box-shadow: 0px -1px 3px 0px rgba(0,0,0,0.2);height: 200px" required >
{{$order->content}}
                            </textarea>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="checkbox checkbox-secondary">
                                                <button type="submit" class="btn btn-danger btn-block ">تعديل الطلب</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
