                        ...
                        <div class="card-body">
                            <form action="{{route('page.update',$page->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="exampleInputname"  value="{{$page->title}}" placeholder="عنوان الصفحه">
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="exampleInputEmail1">وصف</label>
                                    <textarea class="form-control" name="description1" rows="4" placeholder="وصف الخدمه">{{$page->description}}</textarea>
                                ...
                                <div class="form-group mb-0">
                                    <div class="checkbox checkbox-secondary">
                                        <button type="submit" class="btn btn-danger btn-block ">تعديل الصفحه</button>
                                    </div>
                                </div>
                            </form>
                        </div>
