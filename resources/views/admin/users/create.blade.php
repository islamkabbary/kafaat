            ...
            <div class="app-content my-3 my-md-5">
                <div class="side-app">
                    ...
                    <div class="card m-b-20" style="max-width: 1000px">
                        <div class="card-header">
                            <h3 class="card-title">إضافه مستخدم جديد</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{route('users.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control" id="exampleInputname"  placeholder="إسم المستخدم" required>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="exampleInputEmail1">البريد الإلكترونى</label>
                                    <input type="email" name="email" class="form-control" id="exampleInputname"  placeholder="البريد الإلكترونى للمستخدم" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="number" name="phone" class="form-control col-md-8" id="exampleInputname"  placeholder="رقم جوال المستخدم" required>
...
{{--                                            </optgroup>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control" id="exampleInputname"  placeholder="الرقم السرى لتسجيل الدخول لاحقا" required>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="exampleInputEmail1"> الصوره (إختياري)</label>
